...
GtkWidget* create_register_window(void) {
    ...
    /* Avatar - scale đúng kích thước để không full màn */
    ...
    gtk_box_pack_start(GTK_BOX(card),
        add_icon_entry(IMG("icon_user.png"), "Username", &entry_username),
        FALSE, FALSE, 0);

    gtk_box_pack_start(GTK_BOX(card),
        add_icon_entry(IMG("icon_phone.png"), "Phone number", &entry_phone),
        FALSE, FALSE, 0);

    gtk_box_pack_start(GTK_BOX(card),
        add_icon_entry(IMG("icon_mail.png"), "Email", &entry_email),
        FALSE, FALSE, 0);
    ...
    GtkWidget *cpw_box =
        add_icon_entry(IMG("icon_lock.png"), "Confirm password", &entry_confirm_password);
    gtk_entry_set_visibility(GTK_ENTRY(entry_confirm_password), FALSE);
    gtk_box_pack_start(GTK_BOX(card), cpw_box, FALSE, FALSE, 0);
    ...
    /* Register button */
    GtkWidget *btn_register = gtk_button_new_with_label("Sign up");
    gtk_widget_set_name(btn_register, "btn-register");
    g_signal_connect(btn_register, "clicked", G_CALLBACK(on_register), NULL);
    gtk_box_pack_start(GTK_BOX(card), btn_register, FALSE, FALSE, 0);
    ...
    gtk_widget_set_name(login_btn, "login-link");
    g_signal_connect(login_btn, "clicked", G_CALLBACK(on_login_link_click), NULL);

    gtk_box_pack_start(GTK_BOX(footer), footer_text, FALSE, FALSE, 0);
    gtk_box_pack_start(GTK_BOX(footer), login_btn, FALSE, FALSE, 0);
